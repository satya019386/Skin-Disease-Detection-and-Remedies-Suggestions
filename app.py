...
def predict():
    if request.method == 'POST':
        ...
        try:
            ...
            # Pass the predicted class name, selected model name, and the user-uploaded image to the template
            return render_template(output_page, pred_output=predicted_class, selected_model=selected_model, user_image=file_path)
